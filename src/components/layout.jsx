    ...
    <div className={`${theme === "dark" ? "dark:bg-gray-900" : "bg-white"} transition-colors`}>
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white dark:bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:ring-white/10">
